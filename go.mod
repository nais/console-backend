module github.com/nais/console-backend
...
require (
	...
	github.com/nais/dependencytrack v0.0.0-20231110120306-3ebf583fca4f
...
replace github.com/nais/dependencytrack => ../dependencytrack
